...
class JenisKriteriaSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $data = [
            ...
            ['kode_kriteria' => 'C2', 'kriteria' => 'Ketersediaan Transportasi Umum', 'penilaian' => '5', 'rating' => '4', 'faktor' => 'Strengths', 'label' => 'Benefit' ],

            ['kode_kriteria' => 'C3', 'kriteria' => 'Kondisi Geografis yang Mendukung', 'penilaian' => '4', 'rating' => '4', 'faktor' => 'Strengths', 'label' => 'Benefit' ],

            ['kode_kriteria' => 'C4', 'kriteria' => 'Jumlah Sekolah Dasar dan Menengah', 'penilaian' => '4', 'rating' => '5', 'faktor' => 'Strengths', 'label' => 'Benefit' ],

            ['kode_kriteria' => 'C5', 'kriteria' => 'Ketersediaan Pusat Pendidikan Lanjutan', 'penilaian' => '5', 'rating' => '4' , 'faktor' => 'Strengths', 'label' => 'Benefit' ],

            ['kode_kriteria' => 'C6', 'kriteria' => 'Adanya Fasilitas Kesehatan', 'penilaian' => '5', 'rating' => '5' , 'faktor' => 'Strengths', 'label' => 'Benefit' ],
            // ['kode_kriteria' => 'C6', 'kriteria' => 'Adanya Fasilitas Kesehatan', 'penilaian' => '5', 'rating' => '5' , 'faktor' => 'Strengths', 'label' => 'Cost' ],
            ...
            ['kode_kriteria' => 'C12', 'kriteria' => 'Keterbatasan Akses Kesehatan', 'penilaian' => '5 ', 'rating' => '4' , 'faktor' => 'Weaknesses', 'label' => 'Cost' ],
            ...
            ['kode_kriteria' => 'C15', 'kriteria' => 'Rencana Peningkatan Akses Air Bersih', 'penilaian' => '5', 'rating' => '3' , 'faktor' => 'Opportunities', 'label' => 'Benefit' ],

            ['kode_kriteria' => 'C16', 'kriteria' => 'Pengembangan Jaringan Listrik', 'penilaian' => '4', 'rating' => '3' , 'faktor' => 'Opportunities', 'label' => 'Benefit' ],
            ...
            ['kode_kriteria' => 'C19', 'kriteria' => 'Pengembangan Ekowisata', 'penilaian' => '4', 'rating' => '3' , 'faktor' => 'Opportunities', 'label' => 'Benefit' ],
            ...
            ['kode_kriteria' => 'C24', 'kriteria' => 'Perubahan Iklim', 'penilaian' => '2', 'rating' => '1' , 'faktor' => 'Threats', 'label' => 'Cost' ],
